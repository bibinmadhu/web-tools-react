...
export const ToolModal: React.FC<ToolModalProps> = ({
  ...
  const isWideModal = ['pdf-signer', 'pdf-converter', 'pdf-to-markdown', 'invoice-generator', 'agreement-generator', 'curl-converter', 'curl-chain-to-python', 'java-formatter', 'multi-obfuscator', 'qr-generator'].includes(tool.id);
